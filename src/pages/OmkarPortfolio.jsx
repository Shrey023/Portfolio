...
const OmkarPortfolio = () => {
  const { isDark } = useTheme();
  
  const projects = [
    {
      title: 'Dynamic Wireless Charge Ring System for Cars',
      description: 'Dynamic wireless charge ring system enables electric vehicles to charge while driving using inductive coupling and smart sensor-based technology',
      technologies: ['Arduino Uno', 'Wireless Communication (IoT)', 'Smart Infrastructure Integration', 'Electromagnetic Coils'],
      image: 'https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=400&h=300&fit=crop'
    },
    {
      title: 'P2P File Sharing System',
      description: 'Peer-to-peer file sharing enables direct data exchange between devices without relying on a central server.',
      technologies: ['Peer-to-Peer Networking', 'TCP/IP Protocol', 'Encryption & Security Algorithms'],
      image: 'https://images.unsplash.com/photo-1667372393119-3d4c48d07fc9?w=400&h=300&fit=crop'
    },
    {
      title: 'Hospital API System',
      description: 'Comprehensive hospital management system with patient records, appointments, and billing APIs',
  ...
  const extracurriculars = [
    {
      title: 'TRF Robotics Club',
      organization: 'Technical Robotics Foundation',
      description: 'Built a robotic car with gripper using Arduino, IR sensor, and motors'
    },
    {
      title: 'SWDC Club',
      organization: 'Social Welfare and Development Club',
      description: 'Volunteered for Swachh Bharat civic clean-up in Pune'
    },
    {
      title: 'GDSC Contributor',
      organization: 'Google Developer Student Clubs',
      description: 'Active contributor to Google Developer Student Clubs, participating in workshops and hackathons'
    },
    {
      title: 'Event Volunteer',
      organization: 'College Events',
      description: 'Volunteer for various college events, helping with technical setup and coordination'
    }
  ];
      ...
      <section className="relative text-white pt-20 pb-16 overflow-hidden">
        ...
        <div className="container-max text-center relative z-10">
          ...
          >
            ...
            >
              Backend-focused engineer with interest in scalable APIs and cloud infrastructure.
            </motion.p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="section-padding bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm">
        <div className="container-max">
          ...
          >
            ...
            >
              I'm a passionate backend engineer currently pursuing Information Technology at VIT Pune. 
              My focus lies in building robust, scalable, and efficient server-side applications that 
            ...
            <motion.p 
              ...
              variants={itemVariants}
            >
              I specialize in Node.js development, API design, database management, and cloud infrastructure. 
              My approach emphasizes clean code architecture, performance optimization, and security best 
              practices to deliver reliable backend solutions.
            </motion.p>
            <motion.p 
              className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed"
              variants={itemVariants}
            >
              I'm also deeply interested in DevOps practices, automation, and cloud technologies. 
              When I'm not coding, you can find me contributing to open-source projects, participating 
              in developer communities, or exploring new technologies in the backend ecosystem.
            </motion.p>
          </motion.div>
        </div>
      </section>
          ...
          >
            ...
            >
              <div className="flex items-start space-x-6">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-gray-800 dark:text-gray-200 mb-2">B.Tech in Artificial Intelligence and Data Science</h3>
                  ...
                  <p className="text-gray-600 dark:text-gray-400">
                    Currently pursuing my undergraduate degree with focus on Data Science and AI, backend development, 
                    database systems, cloud computing, and software architecture principles.
                  </p>
                </div>
              </div>
            </motion.div>
        ...
        <div className="container-max">
          ...
          >
            <div className="grid md:grid-cols-2 gap-8">
              ...
              >
                <a href="mailto:omkarshinde.592005@gmail.com" className="block">
                  <motion.div 
                ...
                <p className="text-gray-600 dark:text-gray-400">omkarshinde.592005@gmail.com</p>
              </motion.div>
              <motion.div 
                className="text-center hover-3d"
                variants={itemVariants}
                whileHover={{ scale: 1.05 }}
              >
                <a href="https://github.com/Leastfury-dev" target="_blank" rel="noopener noreferrer" className="block">
                  <motion.div 
                    className="w-16 h-16 bg-primary-100 dark:bg-primary-900/30 rounded-full flex items-center justify-center mx-auto mb-4 hover:bg-primary-200 dark:hover:bg-primary-800/50 transition-colors cursor-pointer"
                    whileHover={{ rotate: 360 }}
                    transition={{ duration: 0.6 }}
                ...
                <p className="text-gray-600 dark:text-gray-400">github.com/Leastfury-dev</p>
              </motion.div>
            </div>
            <motion.div 
              ...
              whileHover={{ scale: 1.05 }}
            >
              <a href="https://www.linkedin.com/in/omkar-shinde-87b6052ba?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" rel="noopener noreferrer" className="block">
                <motion.div 
                  className="w-16 h-16 bg-primary-100 dark:bg-primary-900/30 rounded-full flex items-center justify-center mx-auto mb-4 hover:bg-primary-200 dark:hover:bg-primary-800/50 transition-colors cursor-pointer"
                  whileHover={{ rotate: 360 }}
                  transition={{ duration: 0.6 }}
              ...
              <p className="text-gray-600 dark:text-gray-400">linkedin.com/in/omkar-shinde-87b6052ba</p>
            </motion.div>
          </motion.div>
        </div>
      </section>
